...
// ファイルの変更を検知
const watchFiles = () => {
    watch(srcPath.js, series(scriptCopy, browserSyncReload))
...
// npx gulpで出力する内容
exports.default = series(series(clean, cssSass, imgImagemin,scriptCopy), parallel(watchFiles, browserSyncFunc));
