    ...
    <div class="mv__inner">
      ...
      <div class="mv__message-overlay">
        ...
        <div class="mv__overlay">
          <img src="<?php echo get_template_directory_uri(); ?>/assets/img/top/img_mv_cover.png" alt="" />
        </div>
        <div class="mv__message-wrap">
          <h2 class="mv__message">
            高度専門領域を繋ぎ<br>
            全ての人のQOL向上と<br>
            新たな価値を共創。</h2>
          <h3 class="mv__message-text">
            我々はプロフェッショナルとしての誇りを持ち<br>
            その能力を存分に発揮し<br>
    ...
    <section class="about-us layout-about-us">
      <div class="about-us__inner">
        <div class="about-us__contents">
          <h2 class="about-us__ttl">about&nbsp;us</h2>
          <div class="about-us__message">超高齢社会の知の拠点として新たな価値を共に創り出す。</div>
          <p class="about-us__text">
            私たちは「相続」「空き家」など超高齢社会における社会課題に向き合い<br>
            顧客やアライアンス企業と共に理想的な社会の実現を目指すグループ企業です。
          </p>
        </div>
      </div>
